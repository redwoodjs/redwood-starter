...
import { serializeFetchParameter, selectURI, parseAndCheckHttpResponse, checkFetcher, selectHttpOptionsAndBody, defaultPrinter, fallbackHttpConfig, createSignalIfSupported, } from "../http/index.js";
    ...
    function BatchHttpLink(fetchParams) {
        ...
        var batchHandler = function (operations) {
            ...
            var optsAndBody = operations.map(function (operation) {
                return selectHttpOptionsAndBody(operation, print, fallbackHttpConfig, linkConfig, contextConfig);
            });
