...
var StoreWriter = (function () {
    ...
    StoreWriter.prototype.writeToStore = function (store, _a) {
        ...
        if (!isReference(ref)) {
            throw __DEV__ ? new InvariantError("Could not identify object " + JSON.stringify(result)) : new InvariantError(6);
        }
    ...
    StoreWriter.prototype.processSelectionSet = function (_a) {
        ...
        this.flattenFields(selectionSet, result, context, typename).forEach(function (context, field) {
            ...
            if (value !== void 0) {
                ...
                __DEV__ && invariant.error(("Missing field '" + resultKeyNameFromField(field) + "' while writing result " + JSON.stringify(result, null, 2)).substring(0, 1000));
            }
        });
        try {
